        ...
        <section>
            <div className='customercontainer'>
                ...
                <form ref={form} onSubmit={sendEmail} className='form-card'>
                    <input type="text" placeholder='Full Name or Company Name' name='customer_name' className='customer-info' required/><br/>
                    <input type="text" placeholder='Email Address' name='customer_email' className='customer-info' required/><br/>
                    <input type="text" placeholder='Address' name='customer_address' className='customer-info' required/><br/>
